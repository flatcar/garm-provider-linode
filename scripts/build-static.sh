...
GARM_PROVIDER_NAME="${GARM_PROVIDER_NAME:-garm-provider-linode}"
...
GOOS=linux GOARCH=amd64 go build -mod vendor \
    ...
    -ldflags "-extldflags '-static' -s -w -X github.com/cloudbase/garm-provider-linode/provider.Version=${VERSION}" .
